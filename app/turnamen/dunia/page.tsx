...
export default function TurnamenDuniaPage() {
    ...
    const fetchPosts = async () => {
      try {
        const res = await fetch(
          "https://arara.rf.gd/wp-json/wp/v2/posts?categories=5&_embed"
        );
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Turnamen Dunia</h1>

      {/* Postingan pertama (besar) */}
      <Link
        href={`/turnamen/dunia/${firstPost.slug}`}
