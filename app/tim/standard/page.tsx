...
export default function TimStandardPage() {
    ...
    const fetchPosts = async () => {
      try {
        const res = await fetch(
          "https://arara.rf.gd/wp-json/wp/v2/posts?categories=7&_embed"
        );
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Tim osu! Standard</h1>

      {/* Postingan pertama (besar) */}
      <Link
        href={`/tim/standard/${firstPost.slug}`}
